            ...
            <div className="bg-gradient-to-r from-stone-400 to-slate-500 overflow-hidden">
                ...
                <div className="flex flex-col gap-12 text-center items-center mt-40 md:mt-60 justify-center bg-gradient-to-r from-stone-400 to-slate-500 pb-40 md:pb-72">
                    ...
                    <div className="flex gap-5">
                        <a href="mailto:nathanwong3421@gmail.com" className="border-2 border-black px-10 py-2 text-lg text-gray-600 font-semibold transition-transform duration-1000 hover:translate-y-2 hover:bg-gray-500/20">Contact</a>
                        <button className="bg-black px-10 py-2 text-lg text-gray-400 font-semibold hover:opacity-80 transition-transform duration-1000 hover:translate-y-2" onClick={() => document.location = "https://www.linkedin.com/in/nathan-w-76ba78202/"}>Linkedin</button>
                    </div>
